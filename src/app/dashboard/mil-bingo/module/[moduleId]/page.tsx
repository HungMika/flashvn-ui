...
// API services
import { getModuleById } from '@/features/dashboard/Bingo/api/module';
import { getQuestionsByModule, deleteQuestion } from '@/features/dashboard/Bingo/api/question';

// Components
import { useConfirm } from '@/hooks/use-confirm';
import { QuestionCard } from '@/features/dashboard/Bingo/components/QuestionCard';
import { ModuleBar } from '@/features/dashboard/Bingo/components/module-bar';
import { QuestionShowcase } from '@/features/dashboard/Bingo/components/QuestionShowcase';
import { AddQuestionModal } from '@/features/dashboard/Bingo/components/add-question-modal';
import { EditQuestionModal } from '@/features/dashboard/Bingo/components/edit-question-modal';
...
export default function ModuleQuestionPage() {
  ...
  return (
    <>
      <ConfirmDialog />
      <ModuleBar moduleId={moduleId} disabled={questions.length === 0} onStart={() => setShowShowcase(true)} />

      {showShowcase && <QuestionShowcase questions={questions} onClose={() => setShowShowcase(false)} />}
      ...
      <div className="flex flex-col items-center min-h-screen p-4 w-full max-w-screen-lg mx-auto">
        ...
        <div className="mt-4">
          <AddQuestionModal moduleId={moduleId} keywords={keywords} onQuestionAdded={refetchQuestions} />
        </div>
