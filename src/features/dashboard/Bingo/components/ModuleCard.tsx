...
import { generateBingoCards } from '@/features/dashboard/Bingo/api/bingo';
import { deleteModule, updateModule } from '@/features/dashboard/Bingo/api/module';
...
export const ModuleCard = ({ module, onDeleted, onUpdated }: ModuleCardProps) => {
  ...
  const [keywordsString, setKeywordsString] = useState(module.keywords.join('\n'));
