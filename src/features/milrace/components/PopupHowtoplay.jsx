...
export default function PopupHowtoplay({ onClose }) {
  return (
    <div className="fixed top-0 left-0 h-screen w-screen ">
      ...
      >
        <div className="flex items-center justify-between popup-header text-center relative ">
          <h3 className="font-bold text-[#1b1b62] text-lg py-1 mx-auto md:text-2xl md:py-2">
            Cách Chơi - MilRace
          </h3>
          <button
        ...
        <div className="p-3 md:text-2xl md:px-5">
          ...
          <p>
            <b>1.</b> Người chơi lần lượt thảy xúc xắc và di chuyển số ô tương
            ứng trên bàn cờ.
          </p>
          <p>
            <b>2.</b> Nếu di chuyển vào ô thử thách, người chơi phải trả lời một
            câu hỏi ngẫu nhiên.
          </p>
          <p className="pl-3">
          ...
          <p>
            <b>3.</b> Trò chơi tiếp tục theo vòng cho đến khi có người đầu tiên
            đến đích và chiến thắng.
          </p>
        </div>
      </div>
    </div>
